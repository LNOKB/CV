...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _https://LNOKB.github.io/CV/_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://LNOKB.github.io/CV/lana_okubo_cv.pdf)")
}
```
...
The source code is available [on github.com/nstrayer/cv](https://github.com/LNOKB/CV).
